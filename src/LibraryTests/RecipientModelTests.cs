//-----------------------------------------------------------------------
// <copyright file="RecipientModelTests.cs" company="Code Miners Limited">
...
namespace LibraryTests
{
    ...
    public class RecipientModelTests
    {
        ...
        {
            Recipient sender = new Recipient("Firstname", "recipient@example.com");
        ...
        {
            Recipient sender = new Recipient("recipient@example.com");
            Assert.AreEqual("recipient@example.com", sender.Email.ToString(), "Email property not set properly");
        }
    }
}